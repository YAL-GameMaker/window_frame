...
set extName=window_frame
set dllName=window_frame
set gmlDir14=%solutionDir%window_frame.gmx
set gmlDir22=%solutionDir%window_frame_yy
set gmlDir23=%solutionDir%window_frame_23
