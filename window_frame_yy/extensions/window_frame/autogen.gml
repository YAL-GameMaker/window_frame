...
return window_command_check_raw(buffer_get_address(_buf));
...
return window_command_run_raw(buffer_get_address(_buf));

#define window_command_hook
/// window_command_hook(button:int)->bool
var _buf = window_frame_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
return window_command_hook_raw(buffer_get_address(_buf));

#define window_command_unhook
/// window_command_unhook(button:int)->bool
var _buf = window_frame_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
return window_command_unhook_raw(buffer_get_address(_buf));

#define window_command_get_hooked
/// window_command_get_hooked(button:int)->bool
var _buf = window_frame_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
return window_command_get_hooked_raw(buffer_get_address(_buf));
...
return window_command_set_hooked_raw(buffer_get_address(_buf));

#define window_command_get_active
/// window_command_get_active(command:int)->bool
var _buf = window_frame_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
return window_command_get_active_raw(buffer_get_address(_buf));
...
buffer_write(_buf, buffer_s32, argument0);
buffer_write(_buf, buffer_bool, argument1);
return window_command_set_active_raw(buffer_get_address(_buf));
...
return window_frame_init_raw(buffer_get_address(_buf), argument4);

#define window_frame_set_background
/// window_frame_set_background(color:int)->number 
var _buf = window_frame_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
return window_frame_set_background_raw(buffer_get_address(_buf));
...
buffer_write(_buf, buffer_s32, argument2);
buffer_write(_buf, buffer_s32, argument3);
return window_frame_set_region_raw(buffer_get_address(_buf));

#define window_frame_get_rect
/// window_frame_get_rect()->
var _buf = window_frame_prepare_buffer(8);
if (window_frame_get_rect_raw(buffer_get_address(_buf))) {
...
buffer_write(_buf, buffer_s32, argument2);
buffer_write(_buf, buffer_s32, argument3);
return window_frame_set_rect_raw(buffer_get_address(_buf));
...
buffer_write(_buf, buffer_s32, argument0);
buffer_write(_buf, buffer_s32, argument1);
return window_frame_set_min_size_raw(buffer_get_address(_buf));
...
buffer_write(_buf, buffer_s32, argument0);
buffer_write(_buf, buffer_s32, argument1);
return window_frame_set_max_size_raw(buffer_get_address(_buf));
